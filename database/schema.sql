...
CREATE TABLE `kpi_reports` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `fk_kpi_reports_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sops` (
  ...
  KEY `created_by` (`created_by`),
  KEY `status` (`status`),
  CONSTRAINT `sops_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `sops_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'Administrator', 'admin', 'admin@gmail.com', '$2a$12$rD7lf6ZaWSOnDaO5k7MJkukxOTmyP2ZOOl5YvHtUWFEJ8LNsjn1Uq', 'active')
ON DUPLICATE KEY UPDATE `username` = VALUES(`username`);
-- The password for the admin account is: admin123

-- Dump completed on 2026-06-10 11:43:27
