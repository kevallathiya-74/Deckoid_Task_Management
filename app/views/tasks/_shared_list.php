...
@keyframes pulseBlink {
    0% { transform: scale(0.95); box-shadow: 0 0 0 0 rgba(220, 53, 69, 0.7); opacity: 1; }
    50% { opacity: 0.5; }
    70% { transform: scale(1); box-shadow: 0 0 0 6px rgba(220, 53, 69, 0); opacity: 1; }
    100% { transform: scale(0.95); box-shadow: 0 0 0 0 rgba(220, 53, 69, 0); opacity: 1; }
}
.blinking-dot {
    width: 10px;
    height: 10px;
        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    ...
                    let timeClass = 'text-neutral-400';
                    ...
                    return `
                        <div class="d-flex align-items-center py-1">
                            ...
                            <div>
                                ...
                                <div class="${textClass} fw-bold font-outfit text-sm">
                                    ${target.format('DD MMM')} <span class="${timeClass} fw-medium ms-1" style="font-size: 0.75rem;">${target.format('hh:mm A')}</span>
                                </div>
                            </div>
                        </div>
                    `;
                    ...
                    names.forEach((name, index) => {
                        ...
                        avatarsHtml += `
                            <div class="d-flex align-items-center mb-1">
                                <div class="rounded-circle bg-primary-grad text-white d-flex align-items-center justify-content-center fw-bold shadow-sm border border-2 border-white me-2" style="width: 28px; height: 28px; min-width: 28px; font-size: 0.65rem;" title="${name}">
                                    ${initials}
                                </div>
                                <span class="fw-bold text-neutral-800 text-sm font-outfit text-truncate" style="max-width: 150px;">${name}</span>
                            </div>
                        `;
                    });
